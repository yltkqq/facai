...
# 剩余血量
def xueliang(cookie):
    body={"linkId":"pTTvJeSTrpthgk9ASBVGsw"}
...
def apTaskDetail(cookie):
    body={"linkId":"pTTvJeSTrpthgk9ASBVGsw","taskType":"BROWSE_CHANNEL","taskId":357,"channel":4}
...
def apTaskTimeRecord(cookie,taskId):
    log2(cookie)
    body={"linkId":"pTTvJeSTrpthgk9ASBVGsw","taskId":taskId}
...
def happyDigDo(cookie,roundid,rowIdx,colIdx):
    body={"round":roundid,"rowIdx":rowIdx,"colIdx":colIdx,"linkId":"pTTvJeSTrpthgk9ASBVGsw"}
...
def happyDigHelp(cookie,fcwbinviter,fcwbinviteCode):
    ...
    xueliang(cookie)
    log2(cookie)
    body={"linkId":"pTTvJeSTrpthgk9ASBVGsw","inviter":fcwbinviter,"inviteCode":fcwbinviteCode}
...
def happyDigExchange(cookie):
    for n in range(0,4):
        ...
        _apTaskList(cookie)
        msg('开始领取奖励')
        body={"round":n,"linkId":"pTTvJeSTrpthgk9ASBVGsw"}
...
def spring_reward_list(cookie):
    ...
    xueliang(cookie)
    _apTaskList(cookie)
    body={"linkId":"pTTvJeSTrpthgk9ASBVGsw","pageNum":1,"pageSize":5}
...
def wecat(cookie,amountid,poolBaseId,prizeGroupId,prizeBaseId):
    ...
    body={"businessSource":"happyDiggerH5Cash","base":{"id":amountid,"business":"happyDigger","poolBaseId":poolBaseId,"prizeGroupId":prizeGroupId,"prizeBaseId":prizeBaseId,"prizeType":4},"linkId":"pTTvJeSTrpthgk9ASBVGsw"}
